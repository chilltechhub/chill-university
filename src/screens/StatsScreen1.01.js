...
const styles = StyleSheet.create({
  container: { padding: 16, paddingBottom: 200, backgroundColor: '#f5f5f5' },
  ...
  subjectLevel: { fontSize: 12, color: '#666' },

  subjectAccuracy: { fontWeight: '700', color: '#4CAF50' },
  ...
  subjectDetail: { fontSize: 12, color: '#666' },
  ...
  xpText: { fontSize: 11, color: '#999', marginTop: 4 },
  ...
  missionProgress: { fontSize: 12, color: '#666' },

  missionCheck: { color: '#4CAF50', fontSize: 18 },
