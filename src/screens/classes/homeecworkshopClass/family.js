...
const topics = [
    ...
    },
    {
      ...
      practice: [
        { question: 'Why is consistency important in parenting strategies?', options: ['It makes parenting easier for the parent only', 'It helps kids feel secure and know what to expect', 'It keeps kids from ever testing the rules', 'It is only needed once kids become teenagers'], answerIndex: 1, explanation: 'Predictable rules and responses help children feel safe and learn what is expected of them.' },
        { question: 'What are developmental milestones used for?', options: ['Punishing kids who are behind', 'A general guide to growth', 'Comparing children to each other', 'Replacing a parent\'s instincts'], answerIndex: 1, explanation: 'Milestones are a general reference range, helping caregivers recognize typical progress and possible areas needing support.' },
      ],
      apply: {
