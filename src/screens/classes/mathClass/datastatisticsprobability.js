...
const topics = [
    ...
    },
    {
      ...
      practice: [
        { question: 'A researcher surveys only students in the front row of one class to represent the whole school. What is the main problem with this sample?', options: ['It is too large', 'It isn\'t random', 'It has too many people', 'There is no problem'], answerIndex: 1, explanation: 'Choosing only front-row students is not random and likely does not represent the whole school fairly.' },
        { question: 'A poll reports a result with a 95% confidence interval of 48% to 54%. What does this mean?', options: ['Exactly 51% of people agree', 'The method catches the true value 95% of the time', 'There\'s a 95% chance the poll is wrong', 'The sample size was 95 people'], answerIndex: 1, explanation: 'A confidence interval describes the reliability of the estimation method, not a guarantee about one single interval.' },
      ],
      apply: {
