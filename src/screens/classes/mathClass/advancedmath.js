...
const topics = [
    ...
    },
    {
      ...
      practice: [
        { question: 'What does the derivative of a position function represent?', options: ['Total distance traveled', 'Velocity', 'Area under the curve', 'The starting position'], answerIndex: 1, explanation: 'The derivative of position with respect to time gives velocity, the instantaneous rate of change of position.' },
        { question: 'What does a definite integral of a velocity function over a time interval represent?', options: ['The velocity at one instant', 'The acceleration', 'The total displacement', 'The slope of the velocity graph'], answerIndex: 2, explanation: 'Integrating velocity over time accumulates the total displacement traveled during that interval.' },
      ],
      apply: {
