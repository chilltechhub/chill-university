...
const topics = [
    // Text Types & Purposes (Purple)
    {
      ...
      practice: [
        ...
        { question: 'Addressing an opposing viewpoint in your essay and explaining why your position still stands is called...', options: ['Plagiarism', 'A rebuttal', 'A hook', 'Formatting'], answerIndex: 1, explanation: 'Acknowledging and responding to the other side strengthens the credibility of an argument.' },
      ],
      apply: {
    ...
    },
    {
      ...
      practice: [
        ...
        { question: 'Which sentence would fit best in an informative paragraph about sharks?', options: ['I think sharks are the scariest animal!', 'Sharks have lived for 400 million years.', 'Once upon a time, a shark went exploring.', 'You should never swim in the ocean.'], answerIndex: 1, explanation: 'This is a factual, informative statement — not an opinion or a story.' },
      ],
      apply: {
    ...
    },
    {
      ...
      practice: [
        { question: 'A narrative is a piece of writing that...', options: ['Lists facts about animals', 'Tells a story', 'Gives recipe steps', 'Argues an opinion'], answerIndex: 1, explanation: 'Narratives tell stories in order, from beginning to end.' },
        { question: 'Which sentence belongs in a narrative story?', options: ['Dogs have four legs and fur.', 'She grabbed her umbrella and ran.', 'The capital of France is Paris.', 'Water boils at 100 degrees Celsius.'], answerIndex: 1, explanation: 'This sentence describes an action happening to a character — part of a story, not a fact list.' },
      ],
      apply: {
    ...
    // Writing Process (Blue)
    {
      ...
      practice: [
        { question: 'What is the main purpose of the planning stage of writing?', options: ['To publish the final piece', 'To gather and organize ideas', 'To fix spelling mistakes', 'To share writing with others'], answerIndex: 1, explanation: 'Planning happens before drafting, to gather and organize ideas.' },
    ...
    },
    {
      ...
      practice: [
        ...
        { question: 'Editing mainly focuses on fixing...', options: ['The order of ideas', 'Spelling and grammar', 'The essay\'s topic', 'The audience'], answerIndex: 1, explanation: 'Editing addresses surface-level mechanics like spelling and grammar.' },
      ],
      apply: {
    ...
    },
    {
      ...
      practice: [
        { question: 'Publishing happens...', options: ['Before planning starts', 'Last, after editing', 'Instead of drafting', 'Before choosing a topic'], answerIndex: 1, explanation: 'Publishing is the final stage, coming after the piece has been revised and edited.' },
        { question: 'A piece that is ready to publish should be...', options: ['A rough first draft with mistakes', 'Polished and edited', 'Unfinished but close', 'Missing only a title'], answerIndex: 1, explanation: 'Published work should be in its most polished, finished form.' },
      ],
      apply: {
    ...
    // Research & Inquiry (Green)
    {
      ...
      practice: [
        { question: 'Which is a red flag that a website might be an unreliable source?', options: ['It cites where its data came from', 'It has a clear publish date and author', 'It has no author or date', 'It is published by a university'], answerIndex: 2, explanation: 'Missing authorship, dates, and verifiability are strong signs a source may be unreliable.' },
    ...
    },
    {
      ...
      practice: [
        { question: 'Why should research notes usually be written in your own words instead of copied exactly?', options: ['It takes less time', 'It avoids plagiarism', 'Copying is required', 'It makes notes longer'], answerIndex: 1, explanation: 'Paraphrasing builds understanding and prevents accidental plagiarism.' },
        { question: 'Sorting notes into categories by subtopic mainly helps you...', options: ['Forget the source', 'Connect ideas later', 'Make notes longer', 'Skip the outline'], answerIndex: 1, explanation: 'Organized notes are easier to retrieve and connect when drafting.' },
      ],
      apply: {
    ...
    },
    {
      ...
      practice: [
        { question: 'The main reason writers cite their sources is to...', options: ['Make the paper longer', 'Give credit to others', 'Sound more formal', 'Skip the introduction'], answerIndex: 1, explanation: 'Citations credit original authors and allow readers to check claims.' },
    ...
    // Handwriting & Keyboarding (Orange)
    {
      ...
      practice: [
        { question: 'When holding a pencil to write, your grip should be...', options: ['Very tight, in a fist', 'Relaxed, three fingers', 'Loose, with two fingers', 'Held near the top'], answerIndex: 1, explanation: 'A relaxed, three-finger (tripod) grip helps with control and reduces hand fatigue.' },
