...
const topics = [
  {
    ...
    practice: [
      { question: 'Why do communities need rules?', options: ['To make life boring', 'To keep people safe', 'Rules aren\'t needed', 'Only adults need rules'], answerIndex: 1, explanation: 'Rules help keep people safe and make sure everyone is treated fairly.' },
      { question: 'What is the Constitution?', options: ['A list of state capitals', 'The plan for the government', 'A map of the whole country', 'A book of patriotic songs'], answerIndex: 1, explanation: 'The Constitution lays out how the U.S. government works and protects citizens\' rights.' },
    ],
    apply: {
  ...
  },
  {
    ...
    practice: [
      ...
      { question: 'How are seats in the Senate assigned to states?', options: ['Based on population', 'Every state gets 2 seats', 'Based on land area', 'States take turns each year'], answerIndex: 1, explanation: 'Every state gets 2 senators no matter its population, unlike the House, which is based on population.' },
    ],
    apply: {
  ...
  },
  {
    ...
    practice: [
      { question: 'What did the Great Compromise establish?', options: ['A single-chamber legislature', 'A House by population, a Senate by state', 'The abolition of slavery in every state', 'Direct election of the President by voters'], answerIndex: 1, explanation: 'The Great Compromise balanced large and small states by creating two chambers with different representation rules.' },
      { question: 'What does federalism describe?', options: ['Power held only by the President', 'Power split between national and state levels', 'Power held only by the courts', 'Power divided among foreign nations'], answerIndex: 1, explanation: 'Federalism is a system of government where power is shared between a national government and state governments.' },
    ],
    apply: {
