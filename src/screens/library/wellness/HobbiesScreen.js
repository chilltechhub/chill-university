// src/screens/library/wellness/HobbiesScreen.js
...
const CATEGORIES = ['Creative', 'Outdoor', 'Tech', 'Social', 'Learning'];
...
export default function HobbiesScreen() {
  ...
  const loadEntries = async (uid) => {
    ...
    } catch (e) { console.warn('HobbiesScreen', e); }
    setLoading(false);
  };
  ...
  return (
    <View style={{ flex:1, backgroundColor:c.bg0 }}>
      ...
      <View style={{ backgroundColor:c.headerBg, padding:s.lg, borderBottomWidth:0.5, borderBottomColor:c.border }}>
        <Text style={{ fontSize:t.xxl, fontWeight:t.bold, color:c.text1 }}>🎨 Hobbies & Interests</Text>
        <Text style={{ fontSize:t.xs, color:c.text3, marginTop:4 }}>Track and reflect on your hobby habits</Text>
      </View>
      ...
      <View style={{ flexDirection:'row', gap:s.sm, paddingHorizontal:s.lg, paddingBottom:s.sm, backgroundColor:c.bg1, borderBottomWidth:0.5, borderBottomColor:c.border }}>
        <TextInput
          ...
          placeholder="What did you do today?" placeholderTextColor={c.text4}
          ...
          ListEmptyComponent={
            <View style={{ alignItems:'center', paddingTop:60 }}>
              ...
              <Text style={{ fontSize:t.md, color:c.text3, textAlign:'center' }}>
                Log your first hobby to get started
              </Text>
            </View>
          }
          renderItem={({ item }) => (
