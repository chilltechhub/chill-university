...
export const LINGO_BANK = {
  ...
  '9-12': [
    ...
    { prompt: "What does the idiom 'estar en las nubes' express?", correct: 'Daydreaming or being distracted', options: ['Daydreaming or being distracted', 'Feeling proud of something', 'Being in a very good mood', 'Being very confused by it'], explanation: "'Estar en las nubes' literally means 'to be in the clouds' and is used to describe someone daydreaming." },
    ...
    { prompt: "How would you politely say 'I would like a coffee, please' in Spanish?", correct: 'Me gustaría un café, por favor', options: ['Me gustaría un café, por favor', 'Dame un café ahora mismo, amigo', 'Me gusta el café con leche', 'Quiero que me des un café ya'], explanation: "'Me gustaría' is a polite conditional form meaning 'I would like'." },
    ...
    { prompt: "What does the idiom 'no tener pelos en la lengua' mean?", correct: 'To speak very bluntly or frankly', options: ['To speak very bluntly or frankly', 'To be unable to find the words', 'To talk much too fast to follow', 'To keep a secret very carefully'], explanation: "Literally 'to have no hairs on the tongue' — used for someone who speaks their mind very directly." },
    { prompt: "What distinguishes 'por' from 'para' when both can mean 'for' in English?", correct: 'Por: cause or exchange. Para: purpose or goal.', options: ['Por: cause or exchange. Para: purpose or goal.', 'Por: formal speech. Para: casual speech.', 'Por: people and places. Para: things.', 'Por: the past. Para: the present or future.'], explanation: '"Por" tends to express cause, means, or exchange, while "para" expresses purpose, goal, or destination.' },
