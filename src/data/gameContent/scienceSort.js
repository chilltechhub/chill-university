  ...
  '6-8': [
    ...
    },
    {
      ...
      items: [
        ...
        { name: '🌙 Europa', correct: 'Moon',   explanation: 'Europa is one of Jupiter’s moons. Moons orbit planets.' },
        { name: '⭐ Sirius', correct: 'Star',   explanation: 'Sirius is the brightest star in our night sky.' },
        { name: '🌌 Andromeda', correct: 'Galaxy', explanation: 'Andromeda is the nearest big galaxy to ours, with hundreds of billions of stars.' },
  ...
  '9-12': [
    {
      ...
      items: [
        ...
        { name: '💪 Turns sugar into usable energy',  correct: 'Mitochondria',  explanation: 'Mitochondria break down glucose to release usable energy (ATP).' },
