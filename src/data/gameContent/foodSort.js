...
export const FOOD_BANK = {
  'K-2': [
    ...
    { food: '🥦 Broccoli',  category: 'Healthy', emoji: '🥦', fact: 'Gram for gram, broccoli has more vitamin C than an orange!' },
    { food: '🥕 Carrot',    category: 'Healthy', emoji: '🥕', fact: 'Carrots have vitamin A, which your eyes need to work well.' },
    { food: '🍔 Burger',    category: 'Junk',    emoji: '🍔', fact: 'Fast-food burgers are high in saturated fat and salt. A treat, not a daily meal.' },
    { food: '🍭 Lollipop',  category: 'Junk',    emoji: '🍭', fact: 'Sugar spikes blood sugar quickly.' },
    { food: '🍟 Fries',     category: 'Junk',    emoji: '🍟', fact: 'Deep frying soaks potatoes in oil, adding lots of fat and calories.' },
    { food: '🍇 Grapes',    category: 'Healthy', emoji: '🍇', fact: 'Grapes are sweet, juicy, and full of water and fiber.' },
  ...
  '6-8': [
    ...
    { food: '🥤 Sports Drink',  category: 'Junk',     emoji: '🥤', fact: 'Sports drinks are mostly sugar water. Like soda, they are for once in a while unless you exercise hard for over an hour.' },
    ...
    { food: '🥔 Veggie Chips',  category: 'Junk',     emoji: '🥔', fact: "They're still fried and salted — not much different from regular chips." },
    { food: '🦃 Turkey Breast', category: 'Healthy',  emoji: '🦃', fact: 'Lean turkey is a low-fat, high-protein choice.' },
    { food: '🍩 Glazed Donut',  category: 'Junk',     emoji: '🍩', fact: 'A donut is fried dough plus a sugar glaze. A treat, not breakfast every day.' },
  ...
  '9-12': [
    { food: '🍠 Sweet Potato',      category: 'Healthy',  emoji: '🍠', fact: 'Sweet potatoes are full of fiber and vitamin A, especially with the skin on.' },
    { food: '🥤 Diet Soda',         category: 'Moderate', emoji: '🥤', fact: 'Diet soda skips the sugar, which is why it is "sometimes" instead of "once in a while" like regular soda. Water is still the everyday drink.' },
...
export const NUTRITION_TIPS = [
  ...
  '💡 "Every day", "sometimes", and "once in a while" are about how OFTEN to eat something. No food is forbidden.',
];
