  ...
  L0M1: {
    ...
    quiz: [
      { question: "Someone online says banks lend out ten times your deposit. What's closer to true?",
        options: ['About right: that is the reserve multiplier at work', 'Loans create deposits; capital and demand limit it', 'Banks can only lend out money they physically hold'],
        answerIndex: 1,
      ...
      { question: 'A $1,000 tax credit versus a $1,000 deduction, in a 22% bracket. Which saves more?',
        options: ['The deduction, since it lowers your income', 'The credit: about $1,000 against about $220', 'They save the same, since both are $1,000'],
        answerIndex: 1,
  ...
  L0M2: {
    ...
    quiz: [
      { question: 'You carry $3,000 at 22% on a card paying 2% cash back. What are the rewards worth?',
        options: ['More than the interest, if you use it often', 'About the same, once the bonuses are added', 'Far less than the interest you are paying'],
        answerIndex: 2,
      ...
      { question: "A company offers to remove negative items from your credit report for a monthly fee. What's true?",
        options: ['They can delete items you can\'t remove', 'You can dispute errors yourself, free', 'It\'s the only legal way to fix a report'],
        answerIndex: 1,
  ...
  L0M3: {
    ...
    quiz: [
      { question: 'Your employer matches 100% up to 5% of pay. You contribute 3%. What\'s happening?',
        options: ['You get the full match already', 'You leave 2% of pay unclaimed', 'The match only starts above 5%'],
        answerIndex: 1,
      ...
      { question: 'You\'re paid a $50,000 salary and told that means no overtime. Is that automatically true?',
        options: ['Yes, salaried always means exempt', 'No, your duties must pass legal tests', 'Only if your job title says manager'],
        answerIndex: 1,
  ...
  L0M4: {
    ...
    quiz: [
      { question: 'LLC nets $100,000; S-Corp election with a $60,000 salary. Roughly what does that save in payroll-type tax, before added costs?',
        options: ['$15,300, all of the 15.3%', '$6,120, 15.3% of $40,000', 'About $4,950, less costs'],
        answerIndex: 2,
      ...
      { question: 'Does forming a single-member LLC lower your taxes by default?',
        options: ['Yes, it lowers them automatically', 'No, not unless you make an election', 'Yes, it becomes a 21% corporation'],
        answerIndex: 1,
  ...
  L0M5: {
    ...
    quiz: [
      { question: 'You have a day job and new side-business profit. What\'s a simple alternative to quarterly estimated payments?',
        options: ['There isn\'t one; quarterly is required', 'More withholding at work via a new W-4', 'Paying it all in April with no penalty'],
        answerIndex: 1,
      ...
      { question: 'A struggling business uses sales tax it collected to pay rent. What\'s the risk?',
        options: ['None; it\'s the business\'s money until due', 'It\'s the government\'s money; owners can be liable', 'None, as long as the business is an LLC'],
        answerIndex: 1,
  ...
  L1M1: {
    ...
    quiz: [
      ...
      { question: 'Your income is commission-based and swings a lot. What should you plan against?',
        options: ['The 12-month average of what you earned', 'Your best months, to stay motivated', 'The lowest three months of the last year'],
        answerIndex: 2,
  ...
  L1M3: {
    ...
    quiz: [
      { question: 'What does a 0% balance transfer actually do to the amount you owe?',
        options: ['Cuts it by the promotional discount', 'Nothing; it moves to a new rate and term', 'Clears it if paid off within the promo'],
        answerIndex: 1,
  ...
  L1M4: {
    ...
    quiz: [
      ...
      { question: 'A raise moves part of your income into a higher bracket. What happens to your take-home?',
        options: ['It can fall, since the higher rate hits all of it', 'It rises; only income above the line is taxed higher', 'It stays flat until you reach the next bracket'],
        answerIndex: 1,
  ...
  L1M5: {
    ...
    quiz: [
      { question: 'What is the clearest reason to insure a risk rather than absorb it?',
        options: ['It is likely to happen at some point', 'It would be unaffordable if it happened', 'The premium is low enough to not notice'],
        answerIndex: 1,
  ...
  L3AM1: {
    ...
    quiz: [
      { question: 'Where does a founder’s common equity normally sit in the capital stack?',
        options: ['First, since it is the founder\'s company', 'Last, after all debt and preferred equity', 'Alongside the senior secured debt holders'],
        answerIndex: 1,
      ...
      { question: 'Why is financing a 10-year asset with a 2-year loan risky even for a profitable business?',
        options: ['The interest rate is always much higher', 'Payments outrun what the asset earns', 'Lenders will not allow that kind of loan'],
        answerIndex: 1,
  ...
  L3AM2: {
    ...
    quiz: [
      { question: 'Who actually lends you the money in an SBA 7(a) loan?',
        options: ['The Small Business Administration itself', 'A bank, with an SBA guarantee behind it', 'The U.S. Treasury, through the SBA'],
        answerIndex: 1,
  ...
  L3AM3: {
    ...
    quiz: [
      { question: 'What is the real cost of grant capital?',
        options: ['Interest, but at a subsidised rate', 'Reporting, restricted use, compliance', 'A small equity share in the business'],
        answerIndex: 1,
  ...
  L3AM5: {
    ...
    quiz: [
      ...
      { question: 'Two offers: a higher valuation with a 2× participating preference, or a lower one with a clean 1× non-participating. Which needs more scrutiny?',
        options: ['The lower valuation: less money now', 'The higher one: the preference eats upside', 'Neither; valuation is all that matters'],
        answerIndex: 1,
  ...
  S1M1: {
    ...
    quiz: [
      { question: 'Which is the stronger starting signal for a venture?',
        options: ['An elegant solution looking for its market', 'A costly problem people already work around', 'A large market with no obvious competitor yet'],
        answerIndex: 1,
  ...
  S1M2: {
    ...
    quiz: [
      { question: 'Which interview question produces the most reliable signal?',
        options: ['"Would you pay $20 a month for this?"', '"Tell me about the last time this happened."', '"Do you think this is a good idea overall?"'],
        answerIndex: 1,
      ...
      { question: 'Why avoid describing your solution during discovery?',
        options: ['They might copy the idea and beat you to it', 'It signals the answer you want to hear', 'It uses up time you need for other questions'],
        answerIndex: 1,
  ...
  S1M3: {
    ...
    quiz: [
      { question: 'Which market estimate would an investor take seriously?',
        options: ['1% of a $10B total market', '4,000 named businesses × $200/mo', 'The market grew 30% last year'],
        answerIndex: 1,
  ...
  S1M4: {
    ...
    quiz: [
      { question: 'Which smoke-test result is the strongest evidence of demand?',
        options: ['500 people signing up with an email', '40 people entering card details to reserve', '10,000 page views from a viral post'],
        answerIndex: 1,
  ...
  L3BM1: {
    ...
    quiz: [
      ...
      { question: 'Your business will occupy 60% of a building you are buying. Why does that number matter?',
        options: ['It sets the property tax rate for the building', 'It makes it owner-occupied, opening SBA loans', 'It decides how the building is depreciated'],
        answerIndex: 1,
  ...
  L3BM3: {
    ...
    quiz: [
      { question: 'Why does a Phase I environmental assessment matter to a buyer specifically?',
        options: ['It is required before insurance is issued', 'Pollution liability can pass to the buyer', 'It sets the tax basis for the property'],
        answerIndex: 1,
  ...
  L3BM5: {
    ...
    quiz: [
      ...
      { question: 'What does cost segregation actually change?',
        options: ['The total depreciation you can ever claim', 'When you claim it: earlier, not more', 'The purchase price basis of the building'],
        answerIndex: 1,
  ...
  L4M1: {
    ...
    quiz: [
      ...
      { question: 'What does self-employment tax apply to that an S-Corp distribution does not?',
        options: ['Nothing; both are treated the same way', 'Social Security and Medicare tax', 'State income tax, and nothing else'],
        answerIndex: 1,
  ...
  L4M2: {
    ...
    quiz: [
      { question: 'What makes an Augusta-rule (\u00a7280A) arrangement hold up?',
        options: ['Staying under 14 days is enough on its own', 'Real business use at a documented market rate', 'Owning the property through the business'],
        answerIndex: 1,
      ...
      { question: 'Section 179 lets you deduct an asset in year one. What does that change?',
        options: ['The total deduction over the asset\'s life', 'The timing: the deduction moves up', 'The price you paid for the asset itself'],
        answerIndex: 1,
  ...
  L4M3: {
    ...
    quiz: [
      { question: 'Why can a solo 401(k) accept more than an ordinary employee 401(k)?',
        options: ['Higher limits apply to all self-employed people', 'You contribute as both employee and employer', 'Contributions to it have no annual cap at all'],
        answerIndex: 1,
      ...
      { question: 'What is the risk of a prohibited transaction in a self-directed retirement account?',
        options: ['A penalty on that one transaction only', 'The whole account can lose its tax status', 'The transaction is simply reversed'],
        answerIndex: 1,
  ...
  L4M4: {
    ...
    quiz: [
      { question: 'What is the point of holding IP in a separate entity from operations?',
        options: ['It reduces the tax rate on licence income', 'Claims against operations can\'t reach the IP', 'It is required in order to register a trademark'],
        answerIndex: 1,
      ...
      { question: 'How much should you rely on charging order protection?',
        options: ['It is the same federal protection everywhere', 'It varies a lot by state, so check yours', 'It only applies to single-member LLCs'],
        answerIndex: 1,
  ...
  L4M5: {
    ...
    quiz: [
      ...
      { question: 'Why does a buy-sell agreement usually need insurance behind it?',
        options: ['Insurers require it before writing a policy', 'It provides the cash to fund the buyout', 'It lowers the valuation of the shares being sold'],
        answerIndex: 1,
  ...
  S2M1: {
    ...
    quiz: [
      { question: 'Which is the better MVP?',
        options: ['Eight features, each about 60% done', 'One core workflow that fully works', 'Every feature, hidden behind a waitlist'],
        answerIndex: 1,
  ...
  S2M2: {
    ...
    quiz: [
      { question: 'Which decision is hardest to reverse later?',
        options: ['Which UI framework you picked at the start', 'The database schema and its relationships', 'Which hosting provider you deploy to'],
        answerIndex: 1,
  ...
  S2M4: {
    ...
    quiz: [
      { question: 'You hire an agency to build your MVP. Which contract term matters most?',
        options: ['The payment schedule and milestones', 'IP ownership assigned to you in writing', 'How often the sprints and demos happen'],
        answerIndex: 1,
  ...
  S2M5: {
    ...
    quiz: [
      { question: 'Why define analytics events before launch rather than after?',
        options: ['It is faster to set up before launch', 'You need a baseline to judge changes', 'Analytics providers require it upfront'],
        answerIndex: 1,
  ...
  S3M1: {
    ...
    quiz: [
      { question: 'Signups are climbing but every cohort\u2019s retention curve trends to zero. What does that mean?',
        options: ['Product-market fit, held back by onboarding', 'No fit: acquisition without retention', 'Normal, since every curve reaches zero eventually'],
        answerIndex: 1,
      ...
      { question: 'What is the conventional Sean Ellis benchmark for product-market fit?',
        options: ['40% would be very disappointed to lose it', '80% of users rate it satisfied or better', '25% month-over-month growth in users'],
        answerIndex: 0,
  ...
  S3M3: {
    ...
    quiz: [
      { question: 'Why is stopping an A/B test as soon as it looks significant a problem?',
        options: ['It wastes the rest of the planned traffic', 'Stopping on a good peek creates false wins', 'Tests must always run at least 30 days'],
        answerIndex: 1,
  ...
  S3M4: {
    ...
    quiz: [
      { question: 'A chunk of your monthly churn is expired cards. What is that called and what should it prompt?',
        options: ['Voluntary churn: time to improve the product', 'Involuntary churn: add dunning and retries', 'Seasonal churn: wait for it to pass'],
        answerIndex: 1,
  ...
  S3M5: {
    ...
    quiz: [
      { question: 'Your blended CAC looks healthy but most signups are organic. What is the risk?',
        options: ['None; blended CAC is the standard measure', 'Organic hides that paid ads lose money', 'It makes lifetime value look higher than it is'],
        answerIndex: 1,
      ...
      { question: 'LTV:CAC is 4:1 but payback takes 30 months. What is the problem?',
        options: ['None; a 4:1 ratio is strong enough', 'Cash goes out long before it comes back', 'The LTV figure must be miscalculated'],
        answerIndex: 1,
  ...
  S4M1: {
    ...
    quiz: [
      { question: 'Net revenue retention is 115%. What does that mean?',
        options: ['You won 15% more new customers than before', 'Existing customers grew revenue by 15%', 'Customer churn is running at 15%'],
        answerIndex: 1,
      ...
      { question: 'Which figure tells you how efficiently growth is being bought?',
        options: ['Gross revenue growth over the year', 'Burn multiple: net burn ÷ net new ARR', 'Headcount growth compared with revenue'],
        answerIndex: 1,
  ...
  S4M2: {
    ...
    quiz: [
      { question: 'Why does a VC\u2019s power-law model matter when you pitch?',
        options: ['They need every investment to return its capital', 'They are looking for outliers, not modest wins', 'They prefer profitable businesses over growing ones'],
        answerIndex: 1,
  ...
  S4M3: {
    ...
    quiz: [
      { question: 'An option pool is expanded pre-money as part of a round. Who is diluted?',
        options: ['Only the incoming investor', 'Existing holders, founders too', 'Everyone equally, investor too'],
        answerIndex: 1,
      ...
      { question: 'What does a one-year cliff do?',
        options: ['Delays the whole grant by one full year', 'Nothing vests for a year, then a year vests', 'Caps vesting at one year of service'],
        answerIndex: 1,
  ...
  S4M4: {
    ...
    quiz: [
      { question: 'When should SOC 2 be started?',
        options: ['Once an enterprise deal requires it', 'Months before the deal that needs it', 'Only if you handle payment card data'],
        answerIndex: 1,
  ...
  S4M5: {
    ...
    quiz: [
      { question: 'A buyer proposes an asset purchase rather than a stock purchase. What is the usual implication for the seller?',
        options: ['It is simpler and usually better for the seller', 'Liabilities and taxes differ, often worse for you', 'The two are the same thing legally'],
        answerIndex: 1,
      ...
      { question: 'What is the main risk in an earnout?',
        options: ['It always pays out less than was agreed', 'You\'re judged on a business you don\'t control', 'It delays the closing date indefinitely'],
        answerIndex: 1,
  ...
  W1M1: {
    ...
    quiz: [
      { question: 'Why does a handbook need an explicit at-will disclaimer?',
        options: ['Federal law requires it for every employer', 'Otherwise it could read as an implied contract', 'It shortens the notice an employee must give'],
        answerIndex: 1,
      ...
      { question: 'What is the weakness of routing every complaint through the line manager?',
        options: ['It is slower than a written complaint form', 'It fails when the manager is the problem', 'It creates far too much paperwork to track'],
        answerIndex: 1,
  ...
  W1M2: {
    ...
    quiz: [
      { question: 'You pay someone a fixed annual salary. Are they automatically exempt from overtime?',
        options: ['Yes, being salaried means exempt', 'No, duties and pay tests apply too', 'Only if they manage other people'],
        answerIndex: 1,
      ...
      { question: 'A worker signs an agreement stating they are an independent contractor. What determines their real status?',
        options: ['The agreement they signed', 'The real working relationship', 'How they file their own taxes'],
        answerIndex: 1,
  ...
  W1M3: {
    ...
    quiz: [
      { question: 'Two employees commit the same policy breach; only one is disciplined. What is the main exposure?',
        options: ['A morale problem among the rest of the team', 'Uneven enforcement backing a discrimination claim', 'Nothing, as long as the policy allows discretion'],
        answerIndex: 1,
