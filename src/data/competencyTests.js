  ...
  portfolio: {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          'Every technical decision, explained in detail',
          'A strong title and a screenshot of the result',
          'The problem, what you did, and what came of it',
          'The full list of tools and languages you used',
        ],
        answer: 2,
      ...
      },
      {
        ...
        options: [
          'Never. A portfolio is only for the wins',
          'Yes, if you can say what you changed after',
          'Yes, always, because honesty is the point',
          'Only if it shows how hard you worked on it',
        ],
        answer: 1,
      ...
      },
      {
        ...
        options: [
          ...
          'Each time you add one, cut the weakest',
          'Once a year, whatever it looks like',
          'When it no longer fits on one screen',
        ],
        answer: 1,
    ...
    questions: [
      {
        ...
        options: [
          '"Something in tech, ideally remote"',
          '"A better job with more responsibility"',
          '"Junior data analyst, mid-size firm, in a year"',
          '"More money doing work I actually enjoy"',
        ],
        answer: 2,
      ...
      },
      {
        ...
        options: [
          ...
          'Find the biggest gap and build proof for it',
          'Take a general course covering the field',
          'Wait until you meet every listed requirement',
        ],
        answer: 1,
      ...
      },
      {
        ...
        options: [
          'A well-informed decision between them',
          'Nothing, plus the feeling of having worked',
          'A ranked shortlist you can act on right away',
          'Useful breadth to talk about in interviews',
        ],
        answer: 1,
      ...
      },
      {
        ...
        options: [
          'A certificate in the subject area',
          'Having read widely about the field',
          'Something you made that resembles the work',
          'A confident, well-practiced interview answer',
        ],
        answer: 2,
    ...
    questions: [
      {
        ...
        options: [
          'Recording everything you did that week',
          'Deciding what to stop, continue, and start',
          'Measuring how productive the week was',
          'Keeping a journal of how the week felt',
        ],
        answer: 1,
      ...
      },
      {
        ...
        options: [
          'At the same time every week, good week or bad',
          'When you feel you have made enough progress',
          'At the end of each month, all in one sitting',
          'Whenever something goes wrong and needs fixing',
        ],
        answer: 0,
    ...
    questions: [
      {
        ...
        options: [
          'Clearing every notification first',
          'Knowing what the block should produce',
          'Blocking out a long enough stretch of time',
          'Having the right music or sound on',
        ],
        answer: 1,
      ...
      },
      {
        ...
        options: [
          'Three hours, to build real momentum',
          '25 minutes on the smallest real piece',
          'An hour of research and careful planning',
      ...
      },
      {
        ...
        options: [
          'Wasted, since the goal was not reached',
          'Fine, if you noted where to pick it up',
          'Fine regardless, since the time was spent',
          'A sign that the goal was too hard to start',
        ],
        answer: 1,
    ...
    questions: [
      {
        ...
        options: [
          'A well-stocked library ready to use',
          'A 200-item inbox nobody will process',
          'A safe backup of your browser bookmarks',
          'A searchable index of everything you like',
        ],
        answer: 1,
      ...
      },
      {
        ...
        options: [
          'All at once, then sort it all out later',
          'Small batches, each processed before the next',
          'Only the newest items, and skip the rest',
          'By hand, one item at a time, from the start',
        ],
        answer: 1,
      ...
      },
      {
        ...
        options: [
          ...
          'Create a new folder just for that one item',
          'Archive or delete it; no home, no need',
          'File it under Miscellaneous for later',
        ],
        answer: 2,
      ...
      },
      {
        ...
        options: [
          ...
          'That the file format is supported here',
          'That it is backed up somewhere else first',
        ],
        answer: 1,
    ...
    questions: [
      {
        ...
        options: [
          'The material you most want to cover',
          'What learners should be able to do after',
          'How long the session is going to last',
          'The activities you most enjoy running',
        ],
        answer: 1,
      ...
      },
      {
        ...
        options: [
          'Talk faster so all of it fits in',
          'Cut a third of the material',
          'Run over and apologize at the end',
          'Set the rest as homework for later',
        ],
        answer: 1,
      ...
      },
      {
        ...
        options: [
          'Ask "does that make sense?" every so often',
          'Watch closely for confused faces in the room',
          'Have them do something small, then look',
          'Check at the very end with a short quiz',
        ],
        answer: 2,
      ...
      },
      {
        ...
        options: [
          'One more worked example to lock it in',
          'Have them say or write what they took away',
          'Set clear homework for the next session',
          'Preview what is coming up next time',
        ],
        answer: 1,
    ...
    questions: [
      {
        ...
        options: [
          'A strong month or two of income first',
          'A cash buffer and no high-interest debt',
          'A solid understanding of how markets work',
          'A brokerage account with low fees set up',
        ],
        answer: 1,
      ...
      },
      {
        ...
        options: [
          'Index funds, so it keeps growing',
          'Cash you can reach in a day or two',
          'Whatever account pays the highest rate',
      ...
      },
      {
        ...
        options: [
          'Picking better investments over time',
          'Timing when you buy into the market',
          'The share of income you save, for years',
          'Switching to lower-fee investment products',
        ],
        answer: 2,
    ...
    questions: [
      {
        ...
        options: [
          ...
          'Split payments evenly across all of them',
          'Pay off the oldest debt first',
        ],
        answer: 1,
      ...
      },
      {
        ...
        options: [
          'Mostly the balance you owe',
          'Interest, plus a little principal',
          'Fees and charges, nothing else',
          'A fixed share of the balance each month',
        ],
        answer: 1,
      ...
      },
      {
        ...
        options: [
          'You need more room to spend each month',
          'You have a plan to clear it before it ends',
          'The transfer fee is under 5% of the balance',
          'Your current card\'s rate is high',
        ],
        answer: 1,
