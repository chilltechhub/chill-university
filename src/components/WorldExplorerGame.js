...
export default function WorldExplorerGame({ onGameEnd }) {
  ...
  const game = useGame({ subject: 'social_studies', difficulty: adaptive.tier, skillLevel: level, onGameEnd });
  ...
  const handleAnswer = useCallback((opt) => {
    ...
    setTimeout(() => {
      ...
      if (willEnd) {
        ...
        const pool = WORLD_BANK[levelForTier(nextAdaptiveState.tier)];
