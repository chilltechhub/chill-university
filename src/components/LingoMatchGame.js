...
export default function LingoMatchGame({ onGameEnd }) {
  ...
  const game = useGame({ subject: 'foreign_language', difficulty: adaptive.tier, skillLevel: level, onGameEnd });
  ...
  const handleAnswer = useCallback((opt) => {
    ...
    setTimeout(() => {
      ...
      if (willEnd) {
        ...
        const pool = LINGO_BANK[levelForTier(nextAdaptiveState.tier)];
