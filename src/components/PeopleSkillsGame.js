...
export default function PeopleSkillsGame({ onGameEnd }) {
  ...
  const game = useGame({ subject: 'social_skills', difficulty: adaptive.tier, skillLevel: level, onGameEnd });
  ...
  const handleAnswer = useCallback((opt) => {
    ...
    setTimeout(() => {
      ...
      if (willEnd) {
        ...
        const pool = PEOPLE_BANK[levelForTier(nextAdaptiveState.tier)];
