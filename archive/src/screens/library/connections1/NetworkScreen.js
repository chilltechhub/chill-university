  ...
  return (
    <View style={{ flex:1, backgroundColor:c.bg0 }}>
      <View style={{ backgroundColor:c.headerBg, padding:s.lg, borderBottomWidth:0.5, borderBottomColor:c.border }}>
        ...
        <Text style={{ fontSize:t.xs, color:c.text3, marginTop:3 }}>Your professional connections and opportunities.</Text>
      </View>
      <ScrollView contentContainerStyle={{ padding:s.lg, paddingBottom:40 }}>
        <View style={{ alignItems:'center', paddingTop:60 }}>
          ...
          <Text style={{ fontSize:t.sm, color:c.text3, textAlign:'center', lineHeight:20 }}>Your professional connections and opportunities.</Text>
        </View>
      </ScrollView>
    </View>
  );
